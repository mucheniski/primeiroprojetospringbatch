package com.example.primeiroprojetospringbatch.writers.arquivolargurafixa.reader;
...
public class ArquivoLarguraFixaReaderConfig {
	...
	public FlatFileItemReader<Cliente> leituraArquivoLarguraFixaReader() {
		...
		FileSystemResource resource = new FileSystemResource("/home/developer/ws-developer/spring-batch/ArquivoLarguraFixaJob/files/clientes.txt");
