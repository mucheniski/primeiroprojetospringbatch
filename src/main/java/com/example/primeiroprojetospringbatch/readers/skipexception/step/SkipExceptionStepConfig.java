package com.example.primeiroprojetospringbatch.readers.skipexception.step;
...
public class SkipExceptionStepConfig {
	...
	public Step skipExceptionStep(ItemReader<Cliente> skipExceptionReader, ItemWriter<Cliente> skipExceptionWriter) {
		return stepBuilderFactory
				...
				.skip(Exception.class)// Normalmente sao usadas exceptions mais específicas, essa é apenas para amostra
				.skipLimit(2)
				.build();
	}
}
